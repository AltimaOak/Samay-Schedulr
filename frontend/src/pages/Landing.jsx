  ...
  return (
    <div className="min-h-screen bg-slate-50 font-sans text-slate-900 overflow-x-hidden">
      ...
      <nav className="fixed top-0 w-full z-50 bg-white/80 backdrop-blur-md border-b border-slate-200">
        <div className="max-w-7xl mx-auto px-6 h-20 flex items-center justify-between">
          ...
          <div className="hidden md:flex items-center gap-8 text-sm font-semibold text-slate-600">
            ...
            <Link to="/login" className="px-5 py-2.5 rounded-xl hover:bg-slate-100 transition-all">Login</Link>
            <Link to="/signup" className="px-6 py-2.5 bg-indigo-600 text-white rounded-xl shadow-lg shadow-indigo-200 hover:bg-indigo-700 hover:-translate-y-0.5 transition-all">
              Get Started
            </Link>
          </div>
        </div>
      ...
      <section className="pt-40 pb-20 px-6 relative overflow-hidden">
        <div className="max-w-7xl mx-auto flex flex-col lg:flex-row items-center gap-16">
          <div className="flex-1 text-center lg:text-left z-10">
            ...
            <p className="text-xl text-slate-500 leading-relaxed mb-10 max-w-2xl mx-auto lg:mx-0">
              Samay Schedulr combines <b>NLP (Natural Language Processing)</b> and <b>AI Intelligence</b> to analyze your syllabus, parse timetables, and generate personalized study roadmaps—all in one smart platform.
            </p>
      ...
      <section id="features" className="py-24 bg-white border-y border-slate-100">
        <div className="max-w-7xl mx-auto px-6">
          <div className="text-center max-w-3xl mx-auto mb-20">
            <h2 className="text-3xl lg:text-5xl font-black mb-6">Built for Modern Students</h2>
            <p className="text-lg text-slate-500">Ditch the spreadsheets. Our AI analyzes your workload so you can focus on what actually matters—learning.</p>
          </div>

          <div className="grid md:grid-cols-3 gap-8">
            {features.map((f, idx) => (
              <div key={idx} className="p-10 bg-slate-50 rounded-3xl border border-slate-100 hover:shadow-xl hover:-translate-y-2 transition-all duration-300">
      ...
      <section id="how-it-works" className="py-24 bg-slate-50">
        <div className="max-w-7xl mx-auto px-6">
          <div className="text-center max-w-3xl mx-auto mb-20">
            <h2 className="text-3xl lg:text-5xl font-black mb-6">How It Works</h2>
            <p className="text-lg text-slate-500">Simplify your academic journey in four easy steps using our AI-driven approach.</p>
          </div>
          ...
          <div className="grid md:grid-cols-4 gap-8 relative">
            ...
            {[
              ...
              <div key={idx} className="relative z-10 flex flex-col items-center text-center">
                <div className="w-16 h-16 rounded-2xl bg-white border-2 border-indigo-50 shadow-xl flex items-center justify-center text-2xl mb-6 hover:scale-110 transition-transform bg-gradient-to-br from-white to-indigo-50/30">
                  {s.icon}
                </div>
                <div className="text-xs font-bold text-indigo-600 mb-2 uppercase tracking-tighter">Step {s.step}</div>
      ...
      <footer className="py-12 border-t border-slate-200">
        <div className="max-w-7xl mx-auto px-6 flex flex-col md:flex-row justify-between items-center gap-8">
          <div className="flex items-center gap-2">
            <img src={logo} alt="Samay Schedulr" className="h-8 w-auto opacity-50 grayscale hover:grayscale-0 transition-all cursor-pointer" />
          </div>
